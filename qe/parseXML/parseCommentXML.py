...
if __name__ == "__main__":
    ...
    with open('comment_tagged_tokens.csv', 'wb') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_tagged_comment_tokens)


    with open('comment_tokens.csv', 'wb') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_comment_tokens)

    pickle.dump( all_comment_tokens, open( "../../Data files/mrfs_comment_tokens.p", "wb" ) )

# Execution command : python parsing_comment.py ../../xml_csv_files/threads\ XML/final_comments.xml ../../TTL\ files/threads\ TTL/final_comments.ttl ../../Data\ files/mapping_threads_static.p
