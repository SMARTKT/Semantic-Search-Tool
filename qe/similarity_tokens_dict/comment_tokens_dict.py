...
new_f = f[keep_col]
new_f.to_csv("curl_comment_token_similar.csv", index=False)

with open('curl_comment_token_similar.csv') as csvfile:
...
pickle.dump( name_tokens_dict, open( "../../Data files/curl_comment_tokens_dict.p", "wb" ) )